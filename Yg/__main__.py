...
def register(username, password):
    """ Use this to add a new gmail account to your OS' keyring so it can be used in Yg """
    keyring.set_password('Yg', username, password)


def main():
    """ This is the function that is run from commandline with `Yg` """
    import argparse
    parser = argparse.ArgumentParser(
        description='Send a (g)mail with Yg.')
